...
export const ModulePlaceholderPage = ({ title, description }: ModulePlaceholderPageProps) => {
  ...
  return (
    <>
      <PageHeader title={title} subtitle={activeMembership?.organization.name ?? 'GlamPro'} />
      <div className="p-5 sm:p-7">
        <section className="panel flex max-w-2xl flex-col gap-3 p-6">
          ...
          <p className="text-xs leading-relaxed text-muted">
            The foundation already covers tenancy, authorization, validation, security middleware,
            and shared API contracts. This module will be implemented against those foundations
